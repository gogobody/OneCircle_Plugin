...
//        }
    ...
    public function select(){
        return $this->db->select()->from('table.onemessages');
    }
    ...
    public function insert(array $rows){
        return $this->db->query($this->db->insert('table.onemessages')->rows($rows));
    }
    /**
     * 更新记录方法
     *
    ...
    {
        return $this->db->query($condition->update('table.onemessages')->rows($rows));
    }
    ...
    public function size(Typecho_Db_Query $condition)
    {
        return $this->db->fetchObject($condition
            ->select(array('COUNT(DISTINCT table.onemessages.id)' => 'num'))
